    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "        print(f'🎬 Generating video for {job_id}...')\n",
                "        for p in range(20, 95, 20):\n",
                "            time.sleep(2)\n",
                "            jobs_db[job_id]['progress_percent'] = p\n",
                "        os.system(f'ffmpeg -y -loop 1 -i {img_path} -c:v libx264 -t {duration} -pix_fmt yuv420p -r {fps} {out_mp4}')\n",
