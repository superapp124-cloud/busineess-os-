import{j as e}from"./framer-motion-BWofASDg.js";import{r as i}from"./react-vendor-OgzDolXC.js";import{s as f,u as n,i as o,B as d}from"./index.desktop-6Dr8VcEP.js";import{A as w,a as L}from"./alert-DnTIZ7Ps.js";import{T as C,a as v,b as N,c as E}from"./tabs-6PF-oTsL.js";import{a5 as y,D as A,ab as T,bJ as R,af as S}from"./lucide-icons-BeNzLP1b.js";import"./ui-radix-CR5iRT5d.js";const P=()=>{const[r,j]=i.useState(""),[c,m]=i.useState([]),[u,_]=i.useState([]),[x,b]=i.useState(!1);i.useState(""),i.useEffect(()=>{p()},[]);const p=async()=>{try{const a=["profiles","conversations","messages","user_roles","user_points","point_transactions","appointments","service_providers","payments","official_accounts","account_followers","announcements","contacts","fame_cam_posts","fame_leaderboard","brand_partnerships","brand_impressions","mini_apps","business_profiles","crm_leads","doctor_applications"],s=[];for(const t of a)try{const{count:l}=await f.from(t).select("*",{count:"exact",head:!0});s.push({table_name:t,row_count:l||0})}catch{console.log(`Skipping table ${t}`)}_(s.sort((t,l)=>t.table_name.localeCompare(l.table_name)))}catch(a){console.error("Error loading tables:",a),n.error("Failed to load tables")}},h=async a=>{if(a){b(!0);try{const{data:s,error:t}=await f.from(a).select("*").limit(100);if(t)throw t;m(s||[]),j(a),n.success(`Loaded ${(s==null?void 0:s.length)||0} rows from ${a}`)}catch(s){n.error(s.message||"Failed to load table data"),m([])}finally{b(!1)}}},g={createTable:`-- Create a new table with RLS enabled
