import{L as Am,c as vm,C as Rm,r as mc,F as Pm,j as Sm,b as Vm,_ as Bl,k as bm,l as ie,m as ia,p as Ul,u as Cm,d as hs,n as xm,S as Dm,a as It,q as Nm,t as km,f as Mm,w as ii,x as jl,y as Gl,z as gc,A as Fm,B as Om,G as Lm,D as qm,H as Bm}from"./firebase-core-CwKaQk_u.js";var pc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(r,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,Jl(r,n,e)}function Jl(r,t,e){let n=`FIRESTORE (${ir}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw mt(n),new Error(n)}function L(r,t,e,n){let s="Unexpected state";typeof e=="string"?s=e:n=e,r||Jl(t,s,n)}function jm(r,t){r||O(57014,t)}function M(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xl{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class Yl{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(vt.UNAUTHENTICATED))}shutdown(){}}class Gm{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class zm{constructor(t){this.t=t,this.currentUser=vt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){L(this.o===void 0,42304);let n=this.i;const s=c=>this.i!==n?(n=this.i,e(c)):Promise.resolve();let i=new Rt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Rt,t.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const c=i;t.enqueueRetryable(async()=>{await c.promise,await s(this.currentUser)})},u=c=>{D("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(c=>u(c)),setTimeout(()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?u(c):(D("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Rt)}},0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(n=>this.i!==t?(D("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(L(typeof n.accessToken=="string",31837,{l:n}),new Xl(n.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return L(t===null||typeof t=="string",2055,{h:t}),new vt(t)}}class Km{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=vt.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class Qm{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new Km(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable(()=>e(vt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class xo{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class $m{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Sm(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){L(this.o===void 0,3512);const n=i=>{i.error!=null&&D("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,D("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(i.token):Promise.resolve()};this.o=i=>{t.enqueueRetryable(()=>n(i))};const s=i=>{D("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):D("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new xo(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(L(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new xo(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}class Wm{getToken(){return Promise.resolve(new xo(""))}invalidateToken(){}start(t,e){}shutdown(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const s=Hm(40);for(let i=0;i<s.length;++i)n.length<20&&s[i]<e&&(n+=t.charAt(s[i]%62))}return n}}function G(r,t){return r<t?-1:r>t?1:0}function Do(r,t){const e=Math.min(r.length,t.length);for(let n=0;n<e;n++){const s=r.charAt(n),i=t.charAt(n);if(s!==i)return Eo(s)===Eo(i)?G(s,i):Eo(s)?1:-1}return G(r.length,t.length)}const Jm=55296,Xm=57343;function Eo(r){const t=r.charCodeAt(0);return t>=Jm&&t<=Xm}function Ln(r,t,e){return r.length===t.length&&r.every((n,s)=>e(n,t[s]))}function Zl(r){return r+"\0"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qn=-1;class Bn{constructor(t,e,n,s){this.indexId=t,this.collectionGroup=e,this.fields=n,this.indexState=s}}function ko(r){return r.fields.find(t=>t.kind===2)}function Ye(r){return r.fields.filter(t=>t.kind!==2)}function Zm(r,t){let e=G(r.collectionGroup,t.collectionGroup);if(e!==0)return e;for(let n=0;n<Math.min(r.fields.length,t.fields.length);++n)if(e=tg(r.fields[n],t.fields[n]),e!==0)return e;return G(r.fields.length,t.fields.length)}Bn.UNKNOWN_ID=-1;class on{constructor(t,e){this.fieldPath=t,this.kind=e}}function tg(r,t){const e=ut.comparator(r.fieldPath,t.fieldPath);return e!==0?e:G(r.kind,t.kind)}class Un{constructor(t,e){this.sequenceNumber=t,this.offset=e}static empty(){return new Un(0,Kt.min())}}function rh(r,t){const e=r.toTimestamp().seconds,n=r.toTimestamp().nanoseconds+1,s=B.fromTimestamp(n===1e9?new Z(e+1,0):new Z(e,n));return new Kt(s,k.empty(),t)}function sh(r){return new Kt(r.readTime,r.key,qn)}class Kt{constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}static min(){return new Kt(B.min(),k.empty(),qn)}static max(){return new Kt(B.max(),k.empty(),qn)}}function ua(r,t){let e=r.readTime.compareTo(t.readTime);return e!==0?e:(e=k.comparator(r.documentKey,t.documentKey),e!==0?e:G(r.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze="remoteDocuments",fs="owner",Pn="owner",Zr="mutationQueues",og="userId",$t="mutations",Rc="batchId",sn="userMutationsIndex",Pc=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Js(r,t){return[r,xt(t)]}function ch(r,t,e){return[r,xt(t),e]}const ag={},jn="documentMutations",ai="remoteDocumentsV14",ug=["prefixPath","collectionGroup","readTime","documentId"],Xs="documentKeyIndex",cg=["prefixPath","collectionGroup","documentId"],lh="collectionGroupIndex",lg=["collectionGroup","readTime","prefixPath","documentId"],ts="remoteDocumentGlobal",Mo="remoteDocumentGlobalKey",Gn="targets",hh="queryTargetsIndex",hg=["canonicalId","targetId"],zn="targetDocuments",dg=["targetId","path"],la="documentTargetsIndex",fg=["path","targetId"],ui="targetGlobalKey",an="targetGlobal",es="collectionParents",mg=["collectionId","parent"],Kn="clientMetadata",gg="clientId",vi="bundles",pg="bundleId",Ri="namedQueries",_g="name",ha="indexConfiguration",yg="indexId",Fo="collectionGroupIndex",Ig="collectionGroup",zr="indexState",Tg=["indexId","uid"],dh="sequenceNumberIndex",Eg=["uid","sequenceNumber"],Kr="indexEntries",wg=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],fh="documentKeyIndex",Ag=["indexId","uid","orderedDocumentKey"],Pi="documentOverlays",vg=["userId","collectionPath","documentId"],Oo="collectionPathOverlayIndex",Rg=["userId","collectionPath","largestBatchId"],mh="collectionGroupOverlayIndex",Pg=["userId","collectionGroup","largestBatchId"],da="globals",Sg="name",gh=[Zr,$t,jn,Ze,Gn,fs,an,zn,Kn,ts,es,vi,Ri],Vg=[...gh,Pi],ph=[Zr,$t,jn,ai,Gn,fs,an,zn,Kn,ts,es,vi,Ri,Pi],_h=ph,fa=[..._h,ha,zr,Kr],bg=fa,yh=[...fa,da],Cg=yh;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class os{constructor(t,e="asc"){this.field=t,this.dir=e}}function Fg(r,t){return r.dir===t.dir&&r.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gg{constructor(t,e=null,n=[],s=[],i=null,a=null,u=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=s,this.limit=i,this.startAt=a,this.endAt=u,this.Te=null}}function Go(r,t=null,e=[],n=[],s=null,i=null,a=null){return new Gg(r,t,e,n,s,i,a)}function ln(r){const t=M(r);if(t.Te===null){let e=t.path.canonicalString();t.collectionGroup!==null&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(n=>jo(n)).join(","),e+="|ob:",e+=t.orderBy.map(n=>function(i){return i.field.canonicalString()+i.dir}(n)).join(","),ds(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(n=>$n(n)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(n=>$n(n)).join(",")),t.Te=e}return t.Te}function ms(r,t){if(r.limit!==t.limit||r.orderBy.length!==t.orderBy.length)return!1;for(let e=0;e<r.orderBy.length;e++)if(!Fg(r.orderBy[e],t.orderBy[e]))return!1;if(r.filters.length!==t.filters.length)return!1;for(let e=0;e<r.filters.length;e++)if(!Dh(r.filters[e],t.filters[e]))return!1;return r.collectionGroup===t.collectionGroup&&!!r.path.isEqual(t.path)&&!!Fc(r.startAt,t.startAt)&&Fc(r.endAt,t.endAt)}function ci(r){return k.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function li(r,t){return r.filters.filter(e=>e instanceof W&&e.field.isEqual(t))}function Oc(r,t,e){let n=Ys,s=!0;for(const i of li(r,t)){let a=Ys,u=!0;switch(i.op){case"<":case"<=":a=kg(i.value);break;case"==":case"in":case">=":a=i.value;break;case">":a=i.value,u=!1;break;case"!=":case"not-in":a=Ys}Nc({value:n,inclusive:s},{value:a,inclusive:u})<0&&(n=a,s=u)}if(e!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(t)){const a=e.position[i];Nc({value:n,inclusive:s},{value:a,inclusive:e.inclusive})<0&&(n=a,s=e.inclusive);break}}return{value:n,inclusive:s}}function Lc(r,t,e){let n=Re,s=!0;for(const i of li(r,t)){let a=Re,u=!0;switch(i.op){case">=":case">":a=Mg(i.value),u=!1;break;case"==":case"in":case"<=":a=i.value;break;case"<":a=i.value,u=!1;break;case"!=":case"not-in":a=Re}kc({value:n,inclusive:s},{value:a,inclusive:u})>0&&(n=a,s=u)}if(e!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(t)){const a=e.position[i];kc({value:n,inclusive:s},{value:a,inclusive:e.inclusive})>0&&(n=a,s=e.inclusive);break}}return{value:n,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kg=new it(k.comparator);function qt(){return Kg}const Gh=new it(k.comparator);function qr(...r){let t=Gh;for(const e of r)t=t.insert(e.key,e);return t}function zh(r){let t=Gh;return r.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function ee(){return $r()}function Kh(){return $r()}function $r(){return new he(r=>r.toString(),(r,t)=>r.isEqual(t))}const Qg=new it(k.comparator),$g=new nt(k.comparator);function z(...r){let t=$g;for(const e of r)t=t.add(e);return t}const Wg=new nt(G);function ya(){return Wg}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _s{constructor(t,e){this.field=t,this.transform=e}}function Xg(r,t){return r.field.isEqual(t.field)&&function(n,s){return n instanceof hn&&s instanceof hn||n instanceof dn&&s instanceof dn?Ln(n.elements,s.elements,se):n instanceof Jn&&s instanceof Jn?se(n.Ae,s.Ae):n instanceof Hn&&s instanceof Hn}(r.transform,t.transform)}class Yg{constructor(t,e){this.version=t,this.transformResults=e}}class lt{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new lt}static exists(t){return new lt(void 0,t)}static updateTime(t){return new lt(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function ei(r,t){return r.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(r.updateTime):r.exists===void 0||r.exists===t.isFoundDocument()}class xi{}function Yh(r,t){if(!r.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return r.isNoDocument()?new ur(r.key,lt.none()):new ar(r.key,r.data,lt.none());{const e=r.data,n=St.empty();let s=new nt(ut.comparator);for(let i of t.fields)if(!s.has(i)){let a=e.field(i);a===null&&i.length>1&&(i=i.popLast(),a=e.field(i)),a===null?n.delete(i):n.set(i,a),s=s.add(i)}return new de(r.key,n,new Lt(s.toArray()),lt.none())}}function Zg(r,t,e){r instanceof ar?function(s,i,a){const u=s.value.clone(),c=jc(s.fieldTransforms,i,a.transformResults);u.setAll(c),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(r,t,e):r instanceof de?function(s,i,a){if(!ei(s.precondition,i))return void i.convertToUnknownDocument(a.version);const u=jc(s.fieldTransforms,i,a.transformResults),c=i.data;c.setAll(Zh(s)),c.setAll(u),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(r,t,e):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,t,e)}function Wr(r,t,e,n){return r instanceof ar?function(i,a,u,c){if(!ei(i.precondition,a))return u;const h=i.value.clone(),f=Gc(i.fieldTransforms,c,a);return h.setAll(f),a.convertToFoundDocument(a.version,h).setHasLocalMutations(),null}(r,t,e,n):r instanceof de?function(i,a,u,c){if(!ei(i.precondition,a))return u;const h=Gc(i.fieldTransforms,c,a),f=a.data;return f.setAll(Zh(i)),f.setAll(h),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),u===null?null:u.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(m=>m.field))}(r,t,e,n):function(i,a,u){return ei(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):u}(r,t,e)}function tp(r,t){let e=null;for(const n of r.fieldTransforms){const s=t.data.field(n.field),i=Wh(n.transform,s||null);i!=null&&(e===null&&(e=St.empty()),e.set(n.field,i))}return e||null}function Uc(r,t){return r.type===t.type&&!!r.key.isEqual(t.key)&&!!r.precondition.isEqual(t.precondition)&&!!function(n,s){return n===void 0&&s===void 0||!(!n||!s)&&Ln(n,s,(i,a)=>Xg(i,a))}(r.fieldTransforms,t.fieldTransforms)&&(r.type===0?r.value.isEqual(t.value):r.type!==1||r.data.isEqual(t.data)&&r.fieldMask.isEqual(t.fieldMask))}class ar extends xi{constructor(t,e,n,s=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class de extends xi{constructor(t,e,n,s,i=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Zh(r){const t=new Map;return r.fieldMask.fields.forEach(e=>{if(!e.isEmpty()){const n=r.data.field(e);t.set(e,n)}}),t}function jc(r,t,e){const n=new Map;L(r.length===e.length,32656,{Re:e.length,Ve:r.length});for(let s=0;s<e.length;s++){const i=r[s],a=i.transform,u=t.data.field(i.field);n.set(i.field,Jg(a,u,e[s]))}return n}function Gc(r,t,e){const n=new Map;for(const s of r){const i=s.transform,a=e.data.field(s.field);n.set(s.field,Hg(i,a,t))}return n}class ur extends xi{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Ta extends xi{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ip{bt(t){return Et(t,da)}getSessionToken(t){return this.bt(t).get("sessionToken").next(e=>{const n=e==null?void 0:e.value;return n?dt.fromUint8Array(n):dt.EMPTY_BYTE_STRING})}setSessionToken(t,e){return this.bt(t).put({name:"sessionToken",value:e.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vn=255;function Tp(r){if(r===0)return 8;let t=0;return r>>4||(t+=4,r<<=4),r>>6||(t+=2,r<<=2),r>>7||(t+=1),t}function tl(r){const t=64-function(n){let s=0;for(let i=0;i<8;++i){const a=Tp(255&n[i]);if(s+=a,a!==8)break}return s}(r);return Math.ceil(t/8)}class Ep{constructor(){this.buffer=new Uint8Array(1024),this.position=0}Wt(t){const e=t[Symbol.iterator]();let n=e.next();for(;!n.done;)this.Gt(n.value),n=e.next();this.zt()}jt(t){const e=t[Symbol.iterator]();let n=e.next();for(;!n.done;)this.Jt(n.value),n=e.next();this.Ht()}Yt(t){for(const e of t){const n=e.charCodeAt(0);if(n<128)this.Gt(n);else if(n<2048)this.Gt(960|n>>>6),this.Gt(128|63&n);else if(e<"\uD800"||"\uDBFF"<e)this.Gt(480|n>>>12),this.Gt(128|63&n>>>6),this.Gt(128|63&n);else{const s=e.codePointAt(0);this.Gt(240|s>>>18),this.Gt(128|63&s>>>12),this.Gt(128|63&s>>>6),this.Gt(128|63&s)}}this.zt()}Zt(t){for(const e of t){const n=e.charCodeAt(0);if(n<128)this.Jt(n);else if(n<2048)this.Jt(960|n>>>6),this.Jt(128|63&n);else if(e<"\uD800"||"\uDBFF"<e)this.Jt(480|n>>>12),this.Jt(128|63&n>>>6),this.Jt(128|63&n);else{const s=e.codePointAt(0);this.Jt(240|s>>>18),this.Jt(128|63&s>>>12),this.Jt(128|63&s>>>6),this.Jt(128|63&s)}}this.Ht()}Xt(t){const e=this.en(t),n=tl(e);this.tn(1+n),this.buffer[this.position++]=255&n;for(let s=e.length-n;s<e.length;++s)this.buffer[this.position++]=255&e[s]}nn(t){const e=this.en(t),n=tl(e);this.tn(1+n),this.buffer[this.position++]=~(255&n);for(let s=e.length-n;s<e.length;++s)this.buffer[this.position++]=~(255&e[s])}rn(){this.sn(Vn),this.sn(255)}_n(){this.an(Vn),this.an(255)}reset(){this.position=0}seed(t){this.tn(t.length),this.buffer.set(t,this.position),this.position+=t.length}un(){return this.buffer.slice(0,this.position)}en(t){const e=function(i){const a=new DataView(new ArrayBuffer(8));return a.setFloat64(0,i,!1),new Uint8Array(a.buffer)}(t),n=!!(128&e[0]);e[0]^=n?255:128;for(let s=1;s<e.length;++s)e[s]^=n?255:0;return e}Gt(t){const e=255&t;e===0?(this.sn(0),this.sn(255)):e===Vn?(this.sn(Vn),this.sn(0)):this.sn(e)}Jt(t){const e=255&t;e===0?(this.an(0),this.an(255)):e===Vn?(this.an(Vn),this.an(0)):this.an(t)}zt(){this.sn(0),this.sn(1)}Ht(){this.an(0),this.an(1)}sn(t){this.tn(1),this.buffer[this.position++]=t}an(t){this.tn(1),this.buffer[this.position++]=~t}tn(t){const e=t+this.position;if(e<=this.buffer.length)return;let n=2*this.buffer.length;n<e&&(n=e);const s=new Uint8Array(n);s.set(this.buffer),this.buffer=s}}class wp{constructor(t){this.cn=t}Bt(t){this.cn.Wt(t)}xt(t){this.cn.Yt(t)}Mt(t){this.cn.Xt(t)}vt(){this.cn.rn()}}class Ap{constructor(t){this.cn=t}Bt(t){this.cn.jt(t)}xt(t){this.cn.Zt(t)}Mt(t){this.cn.nn(t)}vt(){this.cn._n()}}class kr{constructor(){this.cn=new Ep,this.ln=new wp(this.cn),this.hn=new Ap(this.cn)}seed(t){this.cn.seed(t)}Pn(t){return t===0?this.ln:this.hn}un(){return this.cn.un()}reset(){this.cn.reset()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fp{constructor(){this.sessionToken=dt.EMPTY_BYTE_STRING}getSessionToken(t){return A.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,A.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t_{constructor(t){this.Yo=t.Yo,this.Zo=t.Zo}Xo(t){this.e_=t}t_(t){this.n_=t}r_(t){this.i_=t}onMessage(t){this.s_=t}close(){this.Zo()}send(t){this.Yo(t)}o_(){this.e_()}__(){this.n_()}a_(t){this.i_(t)}u_(t){this.s_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function In(r){return new ap(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pn="RemoteStore";class a_{constructor(t,e,n,s,i){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=i,this.Aa.Oo(a=>{n.enqueueAndForget(async()=>{Be(this)&&(D(pn,"Restarting streams for network reachability change."),await async function(c){const h=M(c);h.Ea.add(4),await cr(h),h.Ra.set("Unknown"),h.Ea.delete(4),await Ts(h)}(this))})}),this.Ra=new o_(n,s)}}async function Ts(r){if(Be(r))for(const t of r.da)await t(!0)}async function cr(r){for(const t of r.da)await t(!1)}function Li(r,t){const e=M(r);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),La(e)?Oa(e):hr(e).O_()&&Fa(e,t))}function tr(r,t){const e=M(r),n=hr(e);e.Ia.delete(t),n.O_()&&Qd(e,t),e.Ia.size===0&&(n.O_()?n.L_():Be(e)&&e.Ra.set("Unknown"))}function Fa(r,t){if(r.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(B.min())>0){const e=r.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}hr(r).Y_(t)}function Qd(r,t){r.Va.Ue(t),hr(r).Z_(t)}function Oa(r){r.Va=new rp({getRemoteKeysForTarget:t=>r.remoteSyncer.getRemoteKeysForTarget(t),At:t=>r.Ia.get(t)||null,ht:()=>r.datastore.serializer.databaseId}),hr(r).start(),r.Ra.ua()}function La(r){return Be(r)&&!hr(r).x_()&&r.Ia.size>0}function Be(r){return M(r).Ea.size===0}function $d(r){r.Va=void 0}async function u_(r){r.Ra.set("Online")}async function c_(r){r.Ia.forEach((t,e)=>{Fa(r,t)})}async function l_(r,t){$d(r),La(r)?(r.Ra.ha(t),Oa(r)):r.Ra.set("Unknown")}async function h_(r,t,e){if(r.Ra.set("Online"),t instanceof id&&t.state===2&&t.cause)try{await async function(s,i){const a=i.cause;for(const u of i.targetIds)s.Ia.has(u)&&(await s.remoteSyncer.rejectListen(u,a),s.Ia.delete(u),s.Va.removeTarget(u))}(r,t)}catch(n){D(pn,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Ii(r,n)}else if(t instanceof ni?r.Va.Ze(t):t instanceof sd?r.Va.st(t):r.Va.tt(t),!e.isEqual(B.min()))try{const n=await Md(r.localStore);e.compareTo(n)>=0&&await function(i,a){const u=i.Va.Tt(a);return u.targetChanges.forEach((c,h)=>{if(c.resumeToken.approximateByteSize()>0){const f=i.Ia.get(h);f&&i.Ia.set(h,f.withResumeToken(c.resumeToken,a))}}),u.targetMismatches.forEach((c,h)=>{const f=i.Ia.get(c);if(!f)return;i.Ia.set(c,f.withResumeToken(dt.EMPTY_BYTE_STRING,f.snapshotVersion)),Qd(i,c);const m=new oe(f.target,c,h,f.sequenceNumber);Fa(i,m)}),i.remoteSyncer.applyRemoteEvent(u)}(r,e)}catch(n){D(pn,"Failed to raise snapshot:",n),await Ii(r,n)}}async function Ii(r,t,e){if(!Le(t))throw t;r.Ea.add(1),await cr(r),r.Ra.set("Offline"),e||(e=()=>Md(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{D(pn,"Retrying IndexedDB access"),await e(),r.Ea.delete(1),await Ts(r)})}function Wd(r,t){return t().catch(e=>Ii(r,e,t))}async function lr(r){const t=M(r),e=ke(t);let n=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:Ve;for(;d_(t);)try{const s=await Wp(t.localStore,n);if(s===null){t.Ta.length===0&&e.L_();break}n=s.batchId,f_(t,s)}catch(s){await Ii(t,s)}Hd(t)&&Jd(t)}function d_(r){return Be(r)&&r.Ta.length<10}function f_(r,t){r.Ta.push(t);const e=ke(r);e.O_()&&e.X_&&e.ea(t.mutations)}function Hd(r){return Be(r)&&!ke(r).x_()&&r.Ta.length>0}function Jd(r){ke(r).start()}async function m_(r){ke(r).ra()}async function g_(r){const t=ke(r);for(const e of r.Ta)t.ea(e.mutations)}async function p_(r,t,e){const n=r.Ta.shift(),s=wa.from(n,t,e);await Wd(r,()=>r.remoteSyncer.applySuccessfulWrite(s)),await lr(r)}async function __(r,t){t&&ke(r).X_&&await async function(n,s){if(function(a){return ed(a)&&a!==P.ABORTED}(s.code)){const i=n.Ta.shift();ke(n).B_(),await Wd(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await lr(n)}}(r,t),Hd(r)&&Jd(r)}async function El(r,t){const e=M(r);e.asyncQueue.verifyOperationInProgress(),D(pn,"RemoteStore received new credentials");const n=Be(e);e.Ea.add(3),await cr(e),n&&e.Ra.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await Ts(e)}async function ta(r,t){const e=M(r);t?(e.Ea.delete(2),await Ts(e)):t||(e.Ea.add(2),await cr(e),e.Ra.set("Unknown"))}function hr(r){return r.ma||(r.ma=function(e,n,s){const i=M(e);return i.sa(),new n_(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(r.datastore,r.asyncQueue,{Xo:u_.bind(null,r),t_:c_.bind(null,r),r_:l_.bind(null,r),H_:h_.bind(null,r)}),r.da.push(async t=>{t?(r.ma.B_(),La(r)?Oa(r):r.Ra.set("Unknown")):(await r.ma.stop(),$d(r))})),r.ma}function ke(r){return r.fa||(r.fa=function(e,n,s){const i=M(e);return i.sa(),new r_(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(r.datastore,r.asyncQueue,{Xo:()=>Promise.resolve(),t_:m_.bind(null,r),r_:__.bind(null,r),ta:g_.bind(null,r),na:p_.bind(null,r)}),r.da.push(async t=>{t?(r.fa.B_(),await lr(r)):(await r.fa.stop(),r.Ta.length>0&&(D(pn,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))})),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K_{constructor(t,e){this.Bu=t,this.serializer=e,this.metadata=new Rt,this.buffer=new Uint8Array,this.Lu=function(){return new TextDecoder("utf-8")}(),this.ku().then(n=>{n&&n.$a()?this.metadata.resolve(n.Qa.metadata):this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q_{constructor(t,e){this.bundleData=t,this.serializer=e,this.cursor=0,this.elements=[];let n=this.bu();if(!n||!n.$a())throw new Error(`The first element of the bundle is not a metadata object, it is
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ly=-1;class rt extends Es{constructor(t,e,n,s){super(t,e,n,s),this.type="firestore",this._queue=new kl,this._persistenceKey=(s==null?void 0:s.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new kl(t),this._firestoreClient=void 0,await t}}}function hy(r,t,e){e||(e=rs);const n=Bl(r,"firestore");if(n.isInitialized(e)){const s=n.getImmediate({identifier:e}),i=n.getOptions(e);if(hs(i,t))return s;throw new b(P.FAILED_PRECONDITION,"initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.")}if(t.cacheSizeBytes!==void 0&&t.localCache!==void 0)throw new b(P.INVALID_ARGUMENT,"cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");if(t.cacheSizeBytes!==void 0&&t.cacheSizeBytes!==-1&&t.cacheSizeBytes<Rd)throw new b(P.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");return t.host&&ia(t.host)&&Ul(t.host),n.initialize({options:t,instanceIdentifier:e})}function If(r,t){const e=typeof r=="object"?r:Vm(),n=typeof r=="string"?r:t||rs,s=Bl(e,"firestore").getImmediate({identifier:n});if(!s._initialized){const i=bm("firestore");i&&pf(s,...i)}return s}function ht(r){if(r._terminated)throw new b(P.FAILED_PRECONDITION,"The client has already been terminated.");return r._firestoreClient||Tf(r),r._firestoreClient}function Tf(r){var n,s,i;const t=r._freezeSettings(),e=function(u,c,h,f){return new Ng(u,c,h,f.host,f.ssl,f.experimentalForceLongPolling,f.experimentalAutoDetectLongPolling,mf(f.experimentalLongPollingOptions),f.useFetchStreams,f.isUsingEmulator)}(r._databaseId,((n=r._app)==null?void 0:n.options.appId)||"",r._persistenceKey,t);r._componentsProvider||(s=t.localCache)!=null&&s._offlineComponentProvider&&((i=t.localCache)!=null&&i._onlineComponentProvider)&&(r._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),r._firestoreClient=new H_(r._authCredentials,r._appCheckCredentials,r._queue,e,r._componentsProvider&&function(u){const c=u==null?void 0:u._online.build();return{_offline:u==null?void 0:u._offline.build(c),_online:c}}(r._componentsProvider))}function dy(r,t){zt("enableIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const e=r._freezeSettings();return Ef(r,Me.provider,{build:n=>new Xa(n,e.cacheSizeBytes,t==null?void 0:t.forceOwnership)}),Promise.resolve()}async function fy(r){zt("enableMultiTabIndexedDbPersistence() will be deprecated in the future, you can use `FirestoreSettings.cache` instead.");const t=r._freezeSettings();Ef(r,Me.provider,{build:e=>new af(e,t.cacheSizeBytes)})}function Ef(r,t,e){if((r=$(r,rt))._firestoreClient||r._terminated)throw new b(P.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");if(r._componentsProvider||r._getSettings().localCache)throw new b(P.FAILED_PRECONDITION,"SDK cache is already specified.");r._componentsProvider={_online:t,_offline:e},Tf(r)}function my(r){if(r._initialized&&!r._terminated)throw new b(P.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const t=new Rt;return r._queue.enqueueAndForgetEvenWhileRestricted(async()=>{try{await async function(n){if(!ne.v())return Promise.resolve();const s=n+xd;await ne.delete(s)}(xa(r._databaseId,r._persistenceKey)),t.resolve()}catch(e){t.reject(e)}}),t.promise}function gy(r){return function(e){const n=new Rt;return e.asyncQueue.enqueueAndForget(async()=>N_(await Za(e),n)),n.promise}(ht(r=$(r,rt)))}function py(r){return J_(ht(r=$(r,rt)))}function _y(r){return X_(ht(r=$(r,rt)))}function yy(r){return Nm(r.app,"firestore",r._databaseId.database),r._delete()}function ra(r,t){const e=ht(r=$(r,rt)),n=new yf;return ny(e,r._databaseId,t,n),n}function wf(r,t){return ry(ht(r=$(r,rt)),t).then(e=>e?new Tt(r,null,e.query):null)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new b(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ut(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}function Iy(){return new je(No)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fy(r){return new sr("sum",cs("sum",r))}function Oy(r){return new sr("avg",cs("average",r))}function Mf(){return new sr("count")}function Ly(r,t){var e,n;return r instanceof sr&&t instanceof sr&&r.aggregateType===t.aggregateType&&((e=r._internalFieldPath)==null?void 0:e.canonicalString())===((n=t._internalFieldPath)==null?void 0:n.canonicalString())}function qy(r,t){return tu(r.query,t.query)&&hs(r.data(),t.data())}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zy(r){r=$(r,et);const t=$(r.firestore,rt);return hf(ht(t),r._key).then(e=>hu(t,r,e))}Ut._jsonSchemaVersion="firestore/querySnapshot/1.0",Ut._jsonSchema={type:_t("string",Ut._jsonSchemaVersion),bundleSource:_t("string","QuerySnapshot"),bundleName:_t("string"),bundle:_t("string")};class ze extends cu{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ft(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new et(this.firestore,null,e)}}function Ky(r){r=$(r,et);const t=$(r.firestore,rt),e=ht(t),n=new ze(t);return Y_(e,r._key).then(s=>new Bt(t,n,r._key,s,new ae(s!==null&&s.hasLocalMutations,!0),r.converter))}function Qy(r){r=$(r,et);const t=$(r.firestore,rt);return hf(ht(t),r._key,{source:"server"}).then(e=>hu(t,r,e))}function $y(r){r=$(r,Tt);const t=$(r.firestore,rt),e=ht(t),n=new ze(t);return xf(r._query),df(e,r._query).then(s=>new Ut(t,n,r,s))}function Wy(r){r=$(r,Tt);const t=$(r.firestore,rt),e=ht(t),n=new ze(t);return Z_(e,r._query).then(s=>new Ut(t,n,r,s))}function Hy(r){r=$(r,Tt);const t=$(r.firestore,rt),e=ht(t),n=new ze(t);return df(e,r._query,{source:"server"}).then(s=>new Ut(t,n,r,s))}function Jy(r,t,e){r=$(r,et);const n=$(r.firestore,rt),s=$i(r.converter,t,e);return pr(n,[Gi(Tn(n),"setDoc",r._key,s,r.converter!==null,e).toMutation(r._key,lt.none())])}function Xy(r,t,e,...n){r=$(r,et);const s=$(r.firestore,rt),i=Tn(s);let a;return a=typeof(t=It(t))=="string"||t instanceof je?ou(i,"updateDoc",r._key,t,e,n):iu(i,"updateDoc",r._key,t),pr(s,[a.toMutation(r._key,lt.exists(!0))])}function Yy(r){return pr($(r.firestore,rt),[new ur(r._key,lt.none())])}function Zy(r,t){const e=$(r.firestore,rt),n=_f(r),s=$i(r.converter,t);return pr(e,[Gi(Tn(r.firestore),"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,lt.exists(!1))]).then(()=>n)}function sa(r,...t){var c,h,f;r=It(r);let e={includeMetadataChanges:!1,source:"default"},n=0;typeof t[n]!="object"||On(t[n])||(e=t[n++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(On(t[n])){const m=t[n];t[n]=(c=m.next)==null?void 0:c.bind(m),t[n+1]=(h=m.error)==null?void 0:h.bind(m),t[n+2]=(f=m.complete)==null?void 0:f.bind(m)}let i,a,u;if(r instanceof et)a=$(r.firestore,rt),u=or(r._key.path),i={next:m=>{t[n]&&t[n](hu(a,r,m))},error:t[n+1],complete:t[n+2]};else{const m=$(r,Tt);a=$(m.firestore,rt),u=m._query;const p=new ze(a);i={next:R=>{t[n]&&t[n](new Ut(a,p,m,R))},error:t[n+1],complete:t[n+2]},xf(r._query)}return function(p,R,N,x){const C=new Bi(x),q=new Ga(R,C,N);return p.asyncQueue.enqueueAndForget(async()=>Ba(await rr(p),q)),()=>{C.Nu(),p.asyncQueue.enqueueAndForget(async()=>Ua(await rr(p),q))}}(ht(a),u,s,i)}function tI(r,t,...e){const n=It(r),s=function(c){const h={bundle:"",bundleName:"",bundleSource:""},f=["bundle","bundleName","bundleSource"];for(const m of f){if(!(m in c)){h.error=`snapshotJson missing required field: ${m}`;break}const p=c[m];if(typeof p!="string"){h.error=`snapshotJson field '${m}' must be a string.`;break}if(p.length===0){h.error=`snapshotJson field '${m}' cannot be an empty string.`;break}m==="bundle"?h.bundle=p:m==="bundleName"?h.bundleName=p:m==="bundleSource"&&(h.bundleSource=p)}return h}(t);if(s.error)throw new b(P.INVALID_ARGUMENT,s.error);let i,a=0;if(typeof e[a]!="object"||On(e[a])||(i=e[a++]),s.bundleSource==="QuerySnapshot"){let u=null;if(typeof e[a]=="object"&&On(e[a])){const c=e[a++];u={next:c.next,error:c.error,complete:c.complete}}else u={next:e[a++],error:e[a++],complete:e[a++]};return function(h,f,m,p,R){let N,x=!1;return ra(h,f.bundle).then(()=>wf(h,f.bundleName)).then(q=>{q&&!x&&(R&&q.withConverter(R),N=sa(q,m||{},p))}).catch(q=>(p.error&&p.error(q),()=>{})),()=>{x||(x=!0,N&&N())}}(n,s,i,u,e[a])}if(s.bundleSource==="DocumentSnapshot"){let u=null;if(typeof e[a]=="object"&&On(e[a])){const c=e[a++];u={next:c.next,error:c.error,complete:c.complete}}else u={next:e[a++],error:e[a++],complete:e[a++]};return function(h,f,m,p,R){let N,x=!1;return ra(h,f.bundle).then(()=>{if(!x){const q=new et(h,R||null,k.fromPath(f.bundleName));N=sa(q,m||{},p)}}).catch(q=>(p.error&&p.error(q),()=>{})),()=>{x||(x=!0,N&&N())}}(n,s,i,u,e[a])}throw new b(P.INVALID_ARGUMENT,`unsupported bundle source: ${s.bundleSource}`)}function eI(r,t){return ey(ht(r=$(r,rt)),On(t)?t:{next:t})}function pr(r,t){return function(n,s){const i=new Rt;return n.asyncQueue.enqueueAndForget(async()=>b_(await Za(n),s,i)),i.promise}(ht(r),t)}function hu(r,t,e){const n=e.docs.get(t._key),s=new ze(r);return new Bt(r,s,t._key,n,new ae(e.hasPendingWrites,e.fromCache),t.converter)}function nI(r){return Of(r,{count:Mf()})}function Of(r,t){const e=$(r.firestore,rt),n=ht(e),s=Ih(t,(i,a)=>new td(a,i.aggregateType,i._internalFieldPath));return ty(n,r._query,s).then(i=>function(u,c,h){const f=new ze(u);return new Af(c,f,h)}(e,r,i))}class rI{constructor(t){this.kind="memory",this._onlineComponentProvider=Me.provider,this._offlineComponentProvider=t!=null&&t.garbageCollector?t.garbageCollector._offlineComponentProvider:{build:()=>new Ja(void 0)}}toJSON(){return{kind:this.kind}}}class sI{constructor(t){let e;this.kind="persistent",t!=null&&t.tabManager?(t.tabManager._initialize(t),e=t.tabManager):(e=Lf(void 0),e._initialize(t)),this._onlineComponentProvider=e._onlineComponentProvider,this._offlineComponentProvider=e._offlineComponentProvider}toJSON(){return{kind:this.kind}}}class iI{constructor(){this.kind="memoryEager",this._offlineComponentProvider=nr.provider}toJSON(){return{kind:this.kind}}}class oI{constructor(t){this.kind="memoryLru",this._offlineComponentProvider={build:()=>new Ja(t)}}toJSON(){return{kind:this.kind}}}function aI(){return new iI}function uI(r){return new oI(r==null?void 0:r.cacheSizeBytes)}function cI(r){return new rI(r)}function lI(r){return new sI(r)}class hI{constructor(t){this.forceOwnership=t,this.kind="persistentSingleTab"}toJSON(){return{kind:this.kind}}_initialize(t){this._onlineComponentProvider=Me.provider,this._offlineComponentProvider={build:e=>new Xa(e,t==null?void 0:t.cacheSizeBytes,this.forceOwnership)}}}class dI{constructor(){this.kind="PersistentMultipleTab"}toJSON(){return{kind:this.kind}}_initialize(t){this._onlineComponentProvider=Me.provider,this._offlineComponentProvider={build:e=>new af(e,t==null?void 0:t.cacheSizeBytes)}}}function Lf(r){return new hI(r==null?void 0:r.forceOwnership)}function fI(){return new dI}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bf extends gI{constructor(t,e){super(t,e),this._firestore=t}get(t){const e=Pe(t,this._firestore),n=new ze(this._firestore);return super.get(t).then(s=>new Bt(this._firestore,n,e._key,s._document,new ae(!1,!1),e.converter))}}function pI(r,t,e){r=$(r,rt);const n={...mI,...e};return function(i){if(i.maxAttempts<1)throw new b(P.INVALID_ARGUMENT,"Max attempts must be at least 1")}(n),function(i,a,u){const c=new Rt;return i.asyncQueue.enqueueAndForget(async()=>{const h=await lf(i);new W_(i.asyncQueue,h,u,a,c).ju()}),c.promise}(ht(r),s=>t(new Bf(r,s)),n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _I(){return new ws("deleteField")}function yI(){return new eu("serverTimestamp")}function II(...r){return new nu("arrayUnion",r)}function TI(...r){return new ru("arrayRemove",r)}function EI(r){return new su("increment",r)}function wI(r){return new Qt(r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AI(r){return ht(r=$(r,rt)),new qf(r,t=>pr(r,t))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vI(r,t){const e=ht(r=$(r,rt));if(!e._uninitializedComponentsProvider||e._uninitializedComponentsProvider._offline.kind==="memory")return zt("Cannot enable indexes when persistence is disabled"),Promise.resolve();const n=function(i){const a=typeof i=="string"?function(h){try{return JSON.parse(h)}catch(f){throw new b(P.INVALID_ARGUMENT,"Failed to parse JSON: "+(f==null?void 0:f.message))}}(i):i,u=[];if(Array.isArray(a.indexes))for(const c of a.indexes){const h=Ll(c,"collectionGroup"),f=[];if(Array.isArray(c.fields))for(const m of c.fields){const p=zi("setIndexConfiguration",Ll(m,"fieldPath"));m.arrayConfig==="CONTAINS"?f.push(new on(p,2)):m.order==="ASCENDING"?f.push(new on(p,0)):m.order==="DESCENDING"&&f.push(new on(p,1))}u.push(new Bn(Bn.UNKNOWN_ID,h,f,Un.empty()))}return u}(t);return sy(e,n)}function Ll(r,t){if(typeof r[t]!="string")throw new b(P.INVALID_ARGUMENT,"Missing string value for: "+t);return r[t]}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uf{constructor(t){this._firestore=t,this.type="PersistentCacheIndexManager"}}function RI(r){var s;r=$(r,rt);const t=ql.get(r);if(t)return t;if(((s=ht(r)._uninitializedComponentsProvider)==null?void 0:s._offline.kind)!=="persistent")return null;const n=new Uf(r);return ql.set(r,n),n}function PI(r){jf(r,!0)}function SI(r){jf(r,!1)}function VI(r){oy(ht(r._firestore)).then(t=>D("deleting all persistent cache indexes succeeded")).catch(t=>zt("deleting all persistent cache indexes failed",t))}function jf(r,t){iy(ht(r._firestore),t).then(e=>D(`setting persistent cache index auto creation isEnabled=${t} succeeded`)).catch(e=>zt(`setting persistent cache index auto creation isEnabled=${t} failed`,e))}const ql=new WeakMap;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xI{constructor(){throw new Error("instances of this class should not be created")}static onExistenceFilterMismatch(t){return du.instance.onExistenceFilterMismatch(t)}}class du{constructor(){this.Mc=new Map}static get instance(){return Ws||(Ws=new du,function(e){if(Hr)throw new Error("a TestingHooksSpi instance is already set");Hr=e}(Ws)),Ws}lt(t){this.Mc.forEach(e=>e(t))}onExistenceFilterMismatch(t){const e=Symbol(),n=this.Mc;return n.set(e,t),()=>n.delete(e)}}let Ws=null;(function(t,e=!0){(function(s){ir=s})(Dm),vm(new Rm("firestore",(n,{instanceIdentifier:s,options:i})=>{const a=n.getProvider("app").getImmediate(),u=new rt(new zm(n.getProvider("auth-internal")),new $m(a,n.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new b(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ce(h.options.projectId,f)}(a,s),a);return i={useFetchStreams:e,...i},u._setSettings(i),u},"PUBLIC").setMultipleInstances(!0)),mc(_c,yc,t),mc(_c,yc,"esm2020")})();const FI=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:cu,AggregateField:sr,AggregateQuerySnapshot:Af,Bytes:Ft,CACHE_SIZE_UNLIMITED:ly,CollectionReference:Wt,DocumentReference:et,DocumentSnapshot:Bt,FieldPath:je,FieldValue:Ge,Firestore:rt,FirestoreError:b,GeoPoint:Ht,LoadBundleTask:yf,PersistentCacheIndexManager:Uf,Query:Tt,QueryCompositeFilterConstraint:wn,QueryConstraint:mr,QueryDocumentSnapshot:Xr,QueryEndAtConstraint:Rs,QueryFieldFilterConstraint:gr,QueryLimitConstraint:As,QueryOrderByConstraint:Qi,QuerySnapshot:Ut,QueryStartAtConstraint:vs,SnapshotMetadata:ae,Timestamp:Z,Transaction:Bf,VectorValue:Qt,WriteBatch:qf,_AutoId:Ei,_ByteString:dt,_DatabaseId:Ce,_DocumentKey:k,_EmptyAppCheckTokenProvider:Wm,_EmptyAuthCredentialsProvider:Yl,_FieldPath:ut,_TestingHooks:xI,_cast:$,_debugAssert:jm,_internalAggregationQueryToProtoRunAggregationQueryRequest:CI,_internalQueryToProtoQueryTarget:bI,_isBase64Available:xg,_logWarn:zt,_validateIsNotUsedTogether:th,addDoc:Zy,aggregateFieldEqual:Ly,aggregateQuerySnapshotEqual:qy,and:Vy,arrayRemove:TI,arrayUnion:II,average:Oy,clearIndexedDbPersistence:my,collection:ay,collectionGroup:uy,connectFirestoreEmulator:pf,count:Mf,deleteAllPersistentCacheIndexes:VI,deleteDoc:Yy,deleteField:_I,disableNetwork:_y,disablePersistentCacheIndexAutoCreation:SI,doc:_f,documentId:Iy,documentSnapshotFromJSON:By,enableIndexedDbPersistence:dy,enableMultiTabIndexedDbPersistence:fy,enableNetwork:py,enablePersistentCacheIndexAutoCreation:PI,endAt:My,endBefore:ky,ensureFirestoreConfigured:ht,executeWrite:pr,getAggregateFromServer:Of,getCountFromServer:nI,getDoc:zy,getDocFromCache:Ky,getDocFromServer:Qy,getDocs:$y,getDocsFromCache:Wy,getDocsFromServer:Hy,getFirestore:If,getPersistentCacheIndexManager:RI,increment:EI,initializeFirestore:hy,limit:Cy,limitToLast:xy,loadBundle:ra,memoryEagerGarbageCollector:aI,memoryLocalCache:cI,memoryLruGarbageCollector:uI,namedQuery:wf,onSnapshot:sa,onSnapshotResume:tI,onSnapshotsInSync:eI,or:Sy,orderBy:by,persistentLocalCache:lI,persistentMultipleTabManager:fI,persistentSingleTabManager:Lf,query:Ry,queryEqual:tu,querySnapshotFromJSON:Uy,refEqual:cy,runTransaction:pI,serverTimestamp:yI,setDoc:Jy,setIndexConfiguration:vI,setLogLevel:Um,snapshotEqual:Gy,startAfter:Ny,startAt:Dy,sum:Fy,terminate:yy,updateDoc:Xy,vector:wI,waitForPendingWrites:gy,where:Py,writeBatch:AI},Symbol.toStringTag,{value:"Module"})),DI={apiKey:"AIzaSyDUUbQlOmkHsrEyMw9AmQBXbjNx11iM7w4",authDomain:"chatr-91067.firebaseapp.com",projectId:"chatr-91067",storageBucket:"chatr-91067.firebasestorage.app",messagingSenderId:"839345688435",appId:"1:839345688435:web:17283f3299c22c1c233f06",measurementId:"G-XXXXXXXXXX"},Wi=gc().length===0?Fm(DI):gc()[0],Gf=Om(Wi);Gf.settings.appVerificationDisabledForTesting=!0;const Hi=new Lm;Hi.setCustomParameters({prompt:"select_account",login_hint:""});Hi.addScope("email");Hi.addScope("profile");const NI=If(Wi);let zf=null;qm().then(r=>{r&&(zf=Bm(Wi))});const OI=Object.freeze(Object.defineProperty({__proto__:null,auth:Gf,db:NI,default:Wi,googleProvider:Hi,get messaging(){return zf}},Symbol.toStringTag,{value:"Module"}));export{Gf as a,OI as f,FI as i,zf as m};
