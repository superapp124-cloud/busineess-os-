    ...
    <div className="flex h-full w-full bg-gray-50 dark:bg-gray-900 overflow-hidden">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800">
          <Link 
            ...
            className="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-gray-950 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 transition-colors"
          >
            Switch Workspace
          </Link>
        </div>
