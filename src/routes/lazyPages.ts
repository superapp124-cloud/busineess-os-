...
export const GuestCallPage = lazy(() => import('@/pages/public/GuestCallPage'));
...
// FinanceOS
export const FinanceWorkspace = lazy(() => import("@/business/finance/FinanceWorkspace").then(m => ({ default: m.default || m.FinanceWorkspace })));
