  ...
  return (
    ...
    >
      <div className="w-full max-w-lg">
        <h1 className="text-4xl font-bold mb-2 tracking-widest text-center uppercase bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">
          CHATR OS
        </h1>
        <p className="text-sm text-slate-400 text-center mb-8">Booting Kernel v2.0...</p>
        ...
        <div className="space-y-2 mb-8">
          {enginesList.map(([engineId, status]) => (
            ...
            >
              <span className="text-sm font-medium">{engineId}</span>
