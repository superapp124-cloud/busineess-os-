          ...
          <CardContent className="pt-4 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-bold">
                  {result.name}
                  {result.opted_out && <span className="ml-2 text-xs font-normal text-muted-foreground">(Name Hidden by User)</span>}
                </p>
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="p-2 rounded-lg bg-muted">
                <p className="text-2xl font-bold">{result.spam_reports}</p>
                <p className="text-xs text-muted-foreground">Spam Reports</p>
              </div>
              <div className="p-2 rounded-lg bg-muted">
                <p className={`text-2xl font-bold ${result.trust_score < 50 ? 'text-red-500' : 'text-green-500'}`}>
