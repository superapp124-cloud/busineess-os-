    ...
    >
      ...
      {isZoomed && (
        ...
        >
          ...
          <span className="text-white text-xs font-semibold">{zoomScale.toFixed(1)}x</span>
        </motion.div>
      )}
      ...
      {!isFullScreen && (
        ...
        >
          ...
          >
            <h2 className="text-base font-bold text-center tracking-tight">{contactName}</h2>
            <p className="text-xs text-white/60 text-center font-medium mt-0.5">
