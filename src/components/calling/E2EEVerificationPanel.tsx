      ...
      {open && (
        <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-80
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-sm font-bold text-white">Secure E2EE Call</p>
              <p className="text-xs text-gray-400">End-to-end encrypted with {partnerName}</p>
            </div>
          </div>
          ...
          <div className="bg-gray-800/60 rounded-xl p-4 mb-3 border border-gray-700/50">
            ...
            <div className="flex items-center justify-between">
              <p className="text-lg font-mono font-bold text-emerald-300 tracking-wider text-center flex-1">
                {hash}
              </p>
              <button
                onClick={copyHash}
