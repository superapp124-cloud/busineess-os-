        ...
        <div className="p-4 rounded-xl border border-purple-500/20 bg-purple-500/5 space-y-3">
          <div className="flex items-center gap-3">
            <Avatar className="w-10 h-10 ring-2 ring-emerald-400/60 shrink-0">
              ...
              <AvatarFallback className="bg-gradient-to-br from-purple-600 to-blue-500 text-sm font-bold text-white">
      ...
      <div className="space-y-2">
        ...
        <div className="p-4 rounded-xl border border-emerald-500/15 bg-emerald-500/5 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs text-white/60">Participation</span>
            <span className={cn('text-xs font-bold', PARTICIPATION_COLOR[participationLevel])}>
              {participationLevel}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="p-2.5 rounded-lg bg-black/30 text-center">
              <div className="text-base font-bold text-emerald-400">{participants.length + 1}</div>
              <div className="text-[9px] text-white/40">In Call</div>
            </div>
            <div className="p-2.5 rounded-lg bg-black/30 text-center">
              <div className="text-base font-bold text-blue-400">{transcript ? '🟢' : '🔴'}</div>
      ...
      <div className="space-y-2">
        ...
        {loadingSuggestions && (
          <div className="flex items-center gap-2 p-3 rounded-xl bg-indigo-500/5 border border-indigo-500/10">
            ...
            <span className="text-xs text-indigo-400">Chatr AI is analyzing the call...</span>
          </div>
        )}

        {suggestions.length === 0 && !loadingSuggestions && (
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/[0.06] text-center">
            <p className="text-xs text-white/30">AI suggestions will appear as the conversation progresses.</p>
          </div>
        )}
