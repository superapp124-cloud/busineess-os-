                ...
                {displayContacts.map((c, i) => (
                  ...
                  >
                    <Avatar className="w-7 h-7 shrink-0">
                      ...
                      <AvatarFallback className={cn('text-xs font-bold text-white bg-gradient-to-br', GRADIENT_COLORS[i % GRADIENT_COLORS.length])}>
                        {(c.full_name || c.username || '?')[0]?.toUpperCase()}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex-1 min-w-0">
                      <div className="text-xs font-medium text-white/90 truncate">{c.full_name || c.username}</div>
        ...
        {activeTab === 1 && (
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={!input}
              className="w-full py-2.5 rounded-xl bg-blue-600/80 hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-bold transition-all flex items-center justify-center gap-2"
            >
        ...
        {activeTab === 2 && (
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={!input}
              className="w-full py-2.5 rounded-xl bg-orange-600/80 hover:bg-orange-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-bold transition-all flex items-center justify-center gap-2"
            >
        ...
        {activeTab === 3 && (
          <div className="space-y-3">
            <div className="p-3 bg-white/[0.03] border border-white/[0.07] rounded-xl space-y-2">
              ...
              <div className="font-mono text-xs text-white/70 break-all">{realMeetingLink}</div>
            </div>
            <button
              onClick={copyLink}
              className={cn(
