        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 p-3 bg-white/[0.03] border border-white/[0.07] rounded-xl">
              ...
              <span className="flex-1 text-xs text-white/70 font-mono truncate">{meetingLink}</span>
              <button
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              >
                <div className="font-mono text-sm font-bold text-white/90">{meetingId}</div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="p-3 bg-white/[0.03] border border-white/[0.07] rounded-xl">
                <div className="font-mono text-sm font-bold text-white/90 tracking-widest">{passcode}</div>
          ...
          <button
            ...
            className="w-full py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.07] hover:bg-white/[0.07] transition-all text-xs text-white/60 hover:text-white/90"
          >
