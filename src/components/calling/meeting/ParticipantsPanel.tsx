  ...
  return (
    <div className="w-[280px] shrink-0 border-l border-white/[0.07] bg-[#09090F] flex flex-col h-full animate-in slide-in-from-right-4 duration-300 shadow-[-20px_0_40px_rgba(0,0,0,0.4)]">
      ...
      <div className="p-4 border-b border-white/[0.07] flex items-center justify-between shrink-0">
        <div>
          <h3 className="text-sm font-semibold text-white/90">Participants</h3>
      ...
      <div className="px-3 py-2 shrink-0">
        <input
          ...
          className="w-full bg-white/[0.04] border border-white/[0.07] rounded-lg px-3 py-1.5 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/40"
        />
      </div>
      ...
      <div className="p-3 shrink-0 border-t border-white/[0.07]">
        <button
          onClick={onInvite}
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-purple-600/80 hover:bg-purple-500 border border-purple-500/30 text-white text-xs font-bold transition-all shadow-lg shadow-purple-900/20"
        >
