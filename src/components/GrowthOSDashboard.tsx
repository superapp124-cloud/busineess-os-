          ...
          <div className="bg-slate-950 text-white p-6 rounded-2xl border border-emerald-500/40 space-y-4 shadow-xl">
            ...
            <div className="space-y-2">
              {[
                ...
                { step: 7, name: 'Organic Impressions', category: 'INDEXING TELEMETRY', status: 'VERIFIED (13.9K)', evidence: 'VERIFIED — 13,900+ Google Search impressions (~98.5% homepage, 86.8% India).', badge: 'bg-emerald-950 text-emerald-300 border-emerald-700' },
                { step: 8, name: 'Organic Clicks', category: 'INDEXING TELEMETRY', status: 'VERIFIED (16)', evidence: 'VERIFIED — 16 empirical Google search clicks (11 Mobile @ 0.57% CTR, 4 Desktop @ 0.034% CTR).', badge: 'bg-emerald-950 text-emerald-300 border-emerald-700' },
