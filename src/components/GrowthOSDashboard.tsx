          ...
          <div className="bg-slate-950 text-white p-6 rounded-2xl border border-emerald-500/40 space-y-4 shadow-xl">
            ...
            <div className="space-y-2">
              {[
                ...
                { step: 7, name: 'Organic Impressions', category: 'INDEXING TELEMETRY', status: 'NOT VERIFIED', evidence: 'Awaiting search demand query surfacing in GSC Performance report.', badge: 'bg-amber-950 text-amber-300 border-amber-800' },
                { step: 8, name: 'Organic Clicks', category: 'INDEXING TELEMETRY', status: 'NOT VERIFIED', evidence: 'Awaiting organic search click-through in GSC Analytics data.', badge: 'bg-amber-950 text-amber-300 border-amber-800' },
                { step: 9, name: 'growth_events Ingestion', category: 'ORGANIC TRAFFIC', status: truthMetrics.visitors > 0 ? 'PASSED' : 'AWAITING VERIFICATION', evidence: `cc_logs organic sessions: ${truthMetrics.visitors}`, badge: truthMetrics.visitors > 0 ? 'bg-emerald-950 text-emerald-300 border-emerald-700' : 'bg-slate-800 text-slate-400 border-slate-700' },
