          ...
          <div className="bg-slate-950 text-white p-6 rounded-2xl border border-emerald-500/40 space-y-4 shadow-xl">
            ...
            <div className="space-y-2">
              {[
                ...
                { step: 6, name: 'Google Indexing / Discovery', category: 'INDEXING TELEMETRY', status: 'VERIFIED', evidence: 'VERIFIED — chatr.chat homepage & core sections indexed and receiving search impressions.', badge: 'bg-emerald-950 text-emerald-300 border-emerald-700' },
                { step: 7, name: 'Organic Impressions', category: 'INDEXING TELEMETRY', status: 'VERIFIED (13.9K)', evidence: 'VERIFIED — 13,900+ impressions (~89.7% brand intent: "chatr" 12,254, "chatrr" 123, "chatrchat" 80).', badge: 'bg-emerald-950 text-emerald-300 border-emerald-700' },
                { step: 8, name: 'Organic Clicks', category: 'INDEXING TELEMETRY', status: 'VERIFIED (16)', evidence: 'VERIFIED — 16 clicks (7 "chatr", 3 "chatr chat" @ 25% CTR, 2 "chatrchat" @ 2.5% CTR, 1 "chatrr").', badge: 'bg-emerald-950 text-emerald-300 border-emerald-700' },
                { step: 9, name: 'growth_events Correlation', category: 'ORGANIC TRAFFIC', status: truthMetrics.visitors > 0 ? 'PASSED' : 'AWAITING VERIFICATION', evidence: `Session correlation: ${truthMetrics.visitors} organic sessions in growth_events DB.`, badge: truthMetrics.visitors > 0 ? 'bg-emerald-950 text-emerald-300 border-emerald-700' : 'bg-slate-800 text-slate-400 border-slate-700' },
