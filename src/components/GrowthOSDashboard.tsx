          ...
          <div className="bg-slate-950 text-white p-6 rounded-2xl border border-emerald-500/40 space-y-4 shadow-xl">
            ...
            <div className="space-y-2">
              {[
                ...
                { step: 8, name: 'Non-Brand Organic Discovery (Problem Queries)', category: 'GOOGLE DISCOVERY LAYER', status: 'NOT YET PROVEN', evidence: 'Awaiting Google ranking & impressions for problem queries (ai resume parser, universal inbox, etc.).', badge: 'bg-amber-950 text-amber-300 border-amber-800' },
