...
>(({ className, ...props }, ref) => (
 <AlertDialogPortal>
 <AlertDialogOverlay />
 <div className="fixed inset-0 z-[350] flex items-center justify-center p-4 sm:p-6 overflow-y-auto pointer-events-none">
...
>(({ className, ...props }, ref) => (
 <AlertDialogPrimitive.Description ref={ref} className={cn("text-secondary text-muted-foreground", className)} {...props} />
));
