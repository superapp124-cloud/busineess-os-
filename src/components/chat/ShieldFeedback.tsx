...
export const ShieldFeedback = ({ messageId, scanId, onFeedbackSubmitted }: ShieldFeedbackProps) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 mt-2 pt-2 border-t border-red-500/10">
      <p className="text-xs text-red-900/60 w-full mb-1">Help improve CHATR Shield:</p>
      
      <Button 
        variant="outline" 
        size="sm" 
        className="h-7 text-xs bg-white/50 border-red-200 text-red-700 hover:bg-red-50"
