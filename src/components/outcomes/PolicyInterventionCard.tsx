    ...
    <div className="bg-zinc-900/90 backdrop-blur-xl border border-rose-500/20 rounded-2xl p-4 shadow-2xl overflow-hidden relative">
      ...
      <div className="flex items-start gap-3 relative z-10">
        ...
        <div className="flex-1">
          <h3 className={`text-sm font-semibold mb-1 ${isApproval ? 'text-amber-400' : 'text-rose-400'}`}>{title}</h3>
          ...
          <div className="flex gap-2">
            {isApproval && (
              <button 
                ...
                className="px-3 py-1.5 bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 text-xs font-medium rounded-lg transition-colors border border-amber-500/20"
              >
            ...
            <button 
              ...
              className="px-3 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-white/80 text-xs font-medium rounded-lg transition-colors"
            >
              Cancel
            </button>
          </div>
