    ...
    <div className="w-full max-w-sm bg-slate-900 border border-slate-700/50 rounded-2xl overflow-hidden shadow-xl mb-4 font-sans">
      ...
      <div className="p-4 border-b border-slate-700/50 bg-indigo-950/30 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs">{data.candidateName}</p>
          </div>
        </div>
        <div>
      ...
      <div className="p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-emerald-400">{data.salary}</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-slate-950/50 border-t border-slate-800">
        <button 
          ...
          className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-xl flex items-center justify-center gap-2 transition-colors"
        >
