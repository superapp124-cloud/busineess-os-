    ...
    <div className="screen-container">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-4 px-1">
          ...
          <h2 className="text-sm font-bold uppercase tracking-wider text-zinc-400">Personalize Experience</h2>
        </div>
          ...
          <div key={i} className="bg-zinc-900/40 border border-zinc-800/50 p-6 rounded-[24px] flex items-center justify-between backdrop-blur-md">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-3xl font-black text-zinc-100">{stat.value}</div>
              </div>
            </div>
