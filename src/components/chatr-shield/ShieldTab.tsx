              ...
              <div className={cn(
                ...
                <div className="flex items-center justify-between mb-3 relative z-10">
                  <div>
                    ...
                    <h3 className="text-lg font-black text-white">{testResult.display_name || testNumber}</h3>
                  </div>
                  <div className={cn(
                ...
                <div className="grid grid-cols-2 gap-4 mt-4 py-4 border-y border-white/5 relative z-10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xl font-black" style={{ color: '#8B5CF6' }}>{testResult.latency_ms}ms</span>
                  </div>
                </div>
