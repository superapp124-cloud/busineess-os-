  ...
  return (
    <div className="w-[320px] h-screen bg-[#0f0f13] border-l border-white/5 flex flex-col hidden xl:flex shrink-0">
      ...
      <div className="flex flex-col items-center justify-center p-8 mt-4">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Hi {firstName}! 👋</h2>
        <p className="text-sm text-slate-400">How can I help you?</p>
      </div>
      ...
      <div className="p-5 border-t border-white/5 bg-[#0f0f13]">
        <div className="relative">
          <input
            ...
            className="w-full pl-4 pr-12 py-3.5 bg-[#15151c] border border-white/10 rounded-2xl text-sm text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500/50 transition-colors"
          />
