    ...
    <div className={cn(
      ...
      {isConnected && connection && (
        <div className="mb-4 p-3 rounded-xl bg-white/[0.04] border border-white/[0.06]">
          ...
          <p className="text-xs font-semibold text-white/80">{connection.name || connection.email}</p>
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b border-white/[0.06]">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h2 className="text-sm font-bold text-white/90">Calendar Connections</h2>
