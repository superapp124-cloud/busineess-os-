      ...
      <form onSubmit={handleSubmit} className="relative bg-black border border-white/10 rounded-2xl flex flex-col overflow-hidden shadow-2xl">
        <div className="flex items-center px-4 py-3">
          ...
          <input
            ...
            className="flex-1 bg-transparent border-none outline-none text-white placeholder-gray-500 text-lg disabled:opacity-50"
            autoFocus
          />
          <button
            type="submit"
        ...
        {isSearching && currentStep && (
          <div className="bg-white/5 px-4 py-2 flex items-center border-t border-white/10 text-xs text-indigo-300 font-mono">
