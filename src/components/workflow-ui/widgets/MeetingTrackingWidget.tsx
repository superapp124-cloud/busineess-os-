  ...
  return (
    ...
    >
      <div className="relative">
        <div className="w-7 h-7 rounded-full bg-indigo-500/20 flex items-center justify-center text-indigo-300 font-medium text-xs border border-indigo-500/30">
      ...
      <div className="p-4 bg-gradient-to-b from-indigo-500/10 to-transparent border-b border-white/[0.05]">
        <div className="flex justify-between items-start mb-3">
          <div>
            ...
            {payload.subtitle && (
              <p className="text-xs text-white/60 mt-0.5">{payload.subtitle}</p>
            )}
          </div>
