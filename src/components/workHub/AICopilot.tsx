            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center text-gray-400 space-y-2">
                  ...
                  <p className="text-sm">I can help you fill out this form, approve requests, or find information.</p>
                </div>
              ) : (
            ...
            <div className="p-4 border-t border-gray-800">
              <form onSubmit={handleSubmit} className="relative">
                <input
                  ...
                  className="w-full bg-chatr-dark border border-gray-700 rounded-xl py-3 pl-4 pr-12 text-sm text-white focus:border-chatr-accent focus:outline-none transition-colors"
                />
                <button 
                  type="submit"
                  disabled={!query.trim()}
