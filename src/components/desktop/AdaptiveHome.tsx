            ...
            <div className="mt-4 grid grid-cols-3 gap-4 animate-in fade-in slide-in-from-top-2 duration-200">
              <div className="space-y-2">
                ...
                {[
                  ...
                  <div key={i} className={cn('flex items-center gap-2 text-xs', item.done ? 'text-white/30 line-through' : 'text-white/70')}>
              ...
              <div className="space-y-2">
                ...
                {['Draft contract reply (2 min)', 'Approve invoice with summary (1 min)', 'Generate interview brief (4 min)'].map((a, i) => (
                  <button key={i} className="flex items-center gap-2 text-xs text-violet-300 hover:text-white transition-colors">
                ...
                <div className="p-4 relative z-10">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="text-sm font-bold text-white/90">Focus Now</div>
            ...
            <div className="p-3 space-y-4 pb-4">
              ...
              <div className="flex items-center justify-between px-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs font-bold text-white/90">AI Copilot</div>
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <div className={cn('text-sm font-bold', voiceActive ? 'text-violet-200' : 'text-white/70')}>
