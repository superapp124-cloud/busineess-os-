          ...
          <>
            <div className="p-8 flex flex-col items-center text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <h2 className="text-2xl font-bold text-foreground">{modalTasks[currentStep].title}</h2>
            ...
            <div className="p-6 pt-2 bg-secondary/50 flex flex-col gap-4">
              <Button 
                ...
                size="lg" 
                className="w-full h-14 rounded-xl text-base font-semibold bg-primary hover:bg-primary/90 text-primary-foreground transition-all shadow-lg"
              >
