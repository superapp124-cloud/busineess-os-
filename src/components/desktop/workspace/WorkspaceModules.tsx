  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="p-4 border-b border-border/50">
        <h2 className="text-lg font-bold mb-3">Work</h2>
        ...
        {loading ? (
          ...
          files.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-48 text-muted-foreground">
              ...
              <p className="text-sm">Files shared in conversations appear here</p>
            </div>
          ) : (
            <div className="space-y-2">
              {files.map(file => (
                <div key={file.id} className="flex items-center gap-3 p-3 rounded-xl border border-border bg-card">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium truncate">{file.content}</p>
...
export const WorkspaceMore: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      <h2 className="text-lg font-bold mb-6">More</h2>
