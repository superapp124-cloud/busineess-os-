        ...
        <>
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              />
              <h3 className="text-sm font-bold">AI Status</h3>
              {status === 'healthy' && (
            ...
            <button
              className={cn(
                'w-full flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-medium border transition-colors',
