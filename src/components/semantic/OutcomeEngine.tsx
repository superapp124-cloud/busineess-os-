      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="p-4">
                ...
                <div className="flex-1 min-w-0 pr-4">
                  {isEditing ? (
                    <input 
                      ...
                      className="text-white font-medium bg-zinc-800 border-none outline-none rounded px-2 w-full mb-1 text-sm"
                  ...
                  <p className="text-zinc-400 text-sm truncate">{suggestion.context}</p>
                </div>
              </div>
            ...
            {queue.length > 1 && (
              <div className="mt-3 text-xs font-medium text-emerald-500/80">
