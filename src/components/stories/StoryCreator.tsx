      ...
      >
        <div className="flex items-center justify-between px-4 pb-4">
          ...
          <div className="text-center">
            <p className="text-xs font-medium uppercase tracking-[0.24em] text-white/55">Status</p>
        ...
        <div className="flex-1 px-4">
          {mediaUrl ? (
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/10 px-3 py-1.5 text-sm text-white/75">
