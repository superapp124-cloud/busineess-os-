          ...
          <div key={field.id} className="space-y-2">
            ...
            {field.type === 'textarea' ? (
              <textarea
                ...
                className="w-full min-h-[100px] p-3 text-sm bg-slate-50 border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#5c22ff]/50"
              ...
              <select
                id={field.id}
                required={field.required}
                className="w-full p-2.5 text-sm bg-slate-50 border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#5c22ff]/50"
                value={formData[field.id] || ''}
                onChange={(e) => handleChange(field.id, e.target.value)}
              >
