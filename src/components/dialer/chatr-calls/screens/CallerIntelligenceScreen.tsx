    ...
    <div className="fixed inset-0 z-[200] bg-black overflow-y-auto">
      <div className="h-64 bg-gradient-to-b from-primary/30 to-black relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col items-center">
          <div className="w-24 h-24 rounded-full bg-[#2C2C2E] border-4 border-black flex items-center justify-center text-4xl font-bold mb-4">
            {caller.name.charAt(0)}
          </div>
          <h1 className="text-3xl font-bold text-center mb-1">{caller.name}</h1>
          <p className="text-gray-400 text-lg mb-4">{caller.number}</p>
      ...
      <div className="p-6">
        <div className="bg-[#1C1C1E] rounded-2xl p-6 mb-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-primary font-bold text-xl">{caller.trustScore || 85}%</div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-300">Verified identity via Chatr network</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center shrink-0">
                <ShieldCheck size={14} className="text-green-500" />
              </div>
              <p className="text-sm text-gray-300">No negative reports found</p>
            </div>
          </div>
        </div>
        ...
        <h2 className="text-xl font-bold mb-4 px-2">AI Insights</h2>
