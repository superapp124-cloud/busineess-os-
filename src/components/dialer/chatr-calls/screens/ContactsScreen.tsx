  ...
  return (
    <div className="screen-container">
      ...
      <div className="flex justify-between items-center mt-10 mb-2 px-4">
        <span className="text-[var(--dialer-text-secondary)] text-sm font-medium">
      ...
      {/* Refresh button */}
      <button
        className="flex items-center gap-2 text-[var(--dialer-primary)] text-sm font-medium mx-4 mb-4 active:opacity-70 transition-opacity"
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-zinc-500 px-8 text-center">
          ...
          <p className="text-base font-semibold text-zinc-300 mb-1">No contacts yet</p>
              ...
              {group.map(contact => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-[var(--dialer-text-secondary)] truncate">
                      {contact.isOnChatr ? (
