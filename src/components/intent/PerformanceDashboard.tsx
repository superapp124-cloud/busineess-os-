    ...
    <div className="bg-gray-950/90 border border-gray-800 rounded-2xl p-5 mt-4 backdrop-blur-xl">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-200">Performance Telemetry</span>
        </div>
        {overallMs > 0 && (
          <div className={`flex items-center gap-1.5 text-xs font-mono px-2.5 py-1 rounded-full ${overallWithinSla ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}>
            ...
            <div key={stage}>
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-gray-300 font-medium">{stage}</span>
                </div>
                <div className="flex items-center gap-2">
