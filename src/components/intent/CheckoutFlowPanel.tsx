        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-xs text-gray-500 mt-0.5">Powered by Zomato</span>
            </div>
          </div>
          ...
          {state === 'auth_required' && (
            <div className="ml-11 bg-gray-800/50 rounded-xl p-4 border border-gray-700">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  <span className="text-sm font-medium text-white block">Provider Login Required</span>
                  <span className="text-xs text-gray-400">Please sign in to Zomato to continue.</span>
                </div>
              </div>
              <button 
          ...
          {(isPast(['auth_required', 'connecting']) || isCurrent(['auth_complete'])) && (
            <div className="ml-11 flex items-center gap-2 text-sm text-green-400">
          ...
          <div className="flex flex-col gap-3 pt-2 border-t border-gray-800">
            ...
            {state === 'tracking' && (
              <div className="ml-11 bg-gray-800/30 rounded-xl h-32 border border-gray-700 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="z-10 flex flex-col items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-300">Arriving in ~{result.deliveryTime}</span>
                </div>
              </div>
            )}
            ...
            {state === 'completed' && (
              <div className="ml-11 bg-green-900/20 rounded-xl p-4 border border-green-900/50 text-center">
                ...
                <span className="block text-sm text-gray-400 mt-1">Enjoy your meal!</span>
              </div>
            )}
          </div>
        )}
