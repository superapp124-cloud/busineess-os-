                ...
                <div className="absolute bottom-full mb-1 left-0 z-20 flex gap-1 bg-zinc-900 border border-white/10 rounded-xl p-1.5 shadow-xl animate-in fade-in zoom-in-95 duration-100">
                  {REACTIONS.map(emoji => (
                    <button
                      ...
                      className="w-7 h-7 rounded-lg hover:bg-white/10 flex items-center justify-center text-base transition-colors"
                    >
                      {emoji}
                    </button>
                  ))}
        ...
        <div className="py-4 space-y-5">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-xs text-white/20 mt-1">Be the first to leave a comment</p>
            </div>
          ) : (
