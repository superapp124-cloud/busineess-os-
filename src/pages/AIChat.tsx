      ...
      setMessages(prev => prev.map(msg => 
        msg.id === streamingId 
          ? {
              ...
              runtimeLabel: response.modelUsed || response.runtime?.model || response.runtime?.label,
    ...
    >
      <section className="relative overflow-hidden px-1 pb-2 pt-3 text-center">
        ...
        >
          ...
          <button
            ...
            onClick={() => handleInstantAction(activeOrbMode.prompt)}
            className={cn(
              'mx-auto mt-2 inline-flex max-w-full items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-semibold',
      ...
      <section className="rounded-lg border border-border/70 bg-card/70 p-4 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1 text-left">
            ...
            <h3 className="mt-2 text-base font-semibold leading-snug">No live alerts yet</h3>
      ...
      <section className="rounded-lg border border-border/70 bg-card/70 p-4 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1 text-left">
            <p className="text-sm font-semibold">Why CHATR stayed quiet</p>
            <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
      ...
      <section className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-lg border border-border/70 bg-card/70 p-4 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1 text-left">
              <p className="text-sm font-semibold">Confidence rules</p>
              <div className="mt-3 grid gap-2 text-xs text-muted-foreground">
        ...
        <div className="rounded-lg border border-border/70 bg-card/70 p-4 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1 text-left">
              <p className="text-sm font-semibold">Trust layer</p>
              <div className="mt-3 grid gap-2 text-xs text-muted-foreground">
                {trustLayer.map((item) => (
      ...
      <section className="rounded-lg border border-border/70 bg-card/70 p-4 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1 text-left">
            <div className="flex items-center justify-between gap-2">
              <p className="text-sm font-semibold">ChatrAI tool registry</p>
              <span className="rounded-full bg-muted px-2 py-0.5 text-[11px] font-medium text-muted-foreground">
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {quickActions.map((action) => (
            <button
              ...
              className="flex min-h-[46px] shrink-0 items-center gap-2 rounded-full border border-border/70 bg-background px-3 py-2 text-left text-sm font-medium shadow-sm transition-colors hover:bg-muted/60"
            >
      ...
      <header className="flex items-center gap-3 border-b border-border/40 bg-background/90 px-4 py-3 backdrop-blur-md">
        ...
        <div className="flex flex-1 items-center gap-2.5">
          ...
          <div className="min-w-0">
            <h1 className="text-base font-semibold leading-tight">ChatrAI</h1>
