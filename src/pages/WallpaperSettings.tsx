  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 space-y-6">
        <div>
          <h2 className="text-sm font-medium text-muted-foreground mb-4 uppercase tracking-wider">Your Wallpapers</h2>
            ...
            {wallpapers.map((wp) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-3 bg-black/50 backdrop-blur-md">
                  <p className="text-white text-sm font-medium text-center truncate">{wp.name}</p>
                </div>
                {selected === wp.id && (
        ...
        <div className="bg-primary/5 rounded-2xl p-5 border border-primary/20 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-sm text-muted-foreground mb-4 relative z-10">Generate beautiful abstract wallpapers using advanced on-device style generation.</p>
          <div className="flex flex-col gap-3 relative z-10">
            <input
              ...
              className="h-11 rounded-xl bg-background border border-primary/20 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all w-full"
            />
            <Button 
