...
export const CityHubPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    canonical.setAttribute('href', `https://chatrchat.in/locations/${currentSlug}`);
    ...
    const breadcrumbSchema = {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: `${cityName} Hub`, item: `https://chatrchat.in/locations/${currentSlug}` },
      ],
    };
