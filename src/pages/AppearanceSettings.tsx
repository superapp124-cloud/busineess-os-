      ...
      <header className="flex items-center justify-between p-4 border-b bg-card z-10 glass-card sticky top-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Customize CHATR infinitely</p>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-8 custom-scrollbar pb-24">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-lg font-semibold">Curated Themes</h2>
          </div>
          <p className="text-sm text-muted-foreground mb-4">Choose from our premium aesthetic collections.</p>
        ...
        <section className="p-5 rounded-2xl bg-card border shadow-sm">
          <h2 className="text-lg font-semibold mb-2">Custom Accent Color</h2>
          <p className="text-sm text-muted-foreground mb-4">Make it truly yours. Enter any HEX code.</p>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-lg font-semibold">Chat Bubble Style</h2>
          </div>
        ...
        <section className="p-4 rounded-2xl bg-chat-background border relative overflow-hidden h-48 flex flex-col justify-end">
          ...
          <div className="relative z-10 flex flex-col gap-3">
            <div className="self-start bg-card text-foreground px-4 py-2 rounded-2xl max-w-[80%] shadow-sm" style={{ 
              ...
              <p className="text-sm">Hey, look at my new theme! 🎨</p>
            </div>
            ...
            <div className="self-end bg-primary text-primary-foreground px-4 py-2 rounded-2xl max-w-[80%] shadow-md" style={{ 
              ...
              <p className="text-sm">Whoa, that is so clean! No extra cost? ✨</p>
            </div>
          </div>
        </section>
