      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 p-6 lg:p-10">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/[0.06] p-4">
            ...
            <h2 className="text-sm font-semibold text-emerald-100">Desktop-first auth</h2>
          ...
          <div className="rounded-lg border border-white/10 bg-white/[0.03] p-4">
            ...
            <h2 className="text-sm font-semibold text-white">No provider API required</h2>
          ...
          <div className="rounded-lg border border-white/10 bg-white/[0.03] p-4">
            ...
            <h2 className="text-sm font-semibold text-white">Ready for real OAuth later</h2>
            <p className="mt-2 text-sm leading-6 text-slate-400">
        ...
        <section>
          <div className="mb-4 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Available after CHATR browser authentication is completed.</p>
            </div>
          </div>
              ...
              >
                <div className="flex min-w-0 items-center gap-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="truncate text-base font-semibold text-white">{provider.name}</h3>
                    <p className="mt-1 truncate text-sm text-slate-500">{provider.category}</p>
                  </div>
                </div>
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-10 shrink-0 rounded-lg border-white/10 bg-white/[0.03] px-4 text-sm font-semibold text-slate-300 hover:bg-white/10 hover:text-white"
                >
                  <ArrowUpRight className="mr-2 h-4 w-4" />
