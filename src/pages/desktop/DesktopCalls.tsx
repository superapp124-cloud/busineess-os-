    ...
    <div className={cn(
      ...
      {!hasVideo && (
        <div className="flex flex-col items-center gap-3 relative z-10">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-purple-600/40 to-blue-600/40 border-2 border-white/10 flex items-center justify-center text-3xl font-bold text-white/80">
            {avatarChar}
          </div>
      ...
      <div className="relative w-full h-full bg-zinc-950 rounded-2xl overflow-hidden border border-white/[0.06] flex items-center justify-center">
        ...
        {videoOff && (
          <div className="flex flex-col items-center gap-3">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-purple-600/40 to-blue-600/40 border-2 border-white/10 flex items-center justify-center text-3xl font-bold text-white/60">
            ...
            <div className={cn('p-3 border-b animate-in slide-in-from-top-2 duration-200', isDark ? 'bg-white/[0.02] border-white/5' : 'bg-zinc-50 border-zinc-200')}>
              <div className="flex gap-1.5">
                <input
                  ...
                  className={cn('flex-1 border rounded-lg px-2 py-1.5 text-xs focus:outline-none focus:border-purple-500/50', isDark ? 'bg-[#0B0F19] border-white/10 text-white placeholder:text-white/30' : 'bg-white border-zinc-300 text-zinc-900 placeholder:text-zinc-400')}
                />
              </div>
                  ...
                  {remoteCount === 0 ? (
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-6">
                      <div className="relative w-80 aspect-video rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900">
                        {localStream && !isVideoOff ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-600/40 to-blue-600/40 border border-white/10 flex items-center justify-center text-2xl font-bold text-white/60">
                      ...
                      <div className="text-center space-y-2">
                        ...
                        <p className="text-white/30 text-sm">Waiting for {remoteUserName || 'participants'} to join...</p>
                        <button onClick={() => setShowInviteModal(true)} className="mt-2 flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-600/80 hover:bg-purple-500 text-white text-xs font-bold transition-all mx-auto">
            ...
            <div className="p-6">
              {summaryLoading ? (
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10 text-sm text-white/80 whitespace-pre-line leading-relaxed">
                    {summary || "No summary could be generated."}
                  </div>
                  <div className="flex justify-end pt-2">
                    <button onClick={() => setShowSummaryModal(false)} className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-sm font-medium transition-colors">
                      Close
                    </button>
                  </div>
                </div>
