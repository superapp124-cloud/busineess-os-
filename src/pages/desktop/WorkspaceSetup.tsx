...
export const WorkspaceSetup: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#0b0b14] flex items-center justify-center text-white p-4">
        <div className="max-w-md w-full bg-white/5 border border-red-500/20 rounded-2xl p-6 text-center">
          ...
          <button 
            ...
            className="w-full h-10 rounded-lg bg-white/10 hover:bg-white/20 transition-colors font-medium text-sm"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#0b0b14] flex flex-col items-center justify-center text-white relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="relative z-10 max-w-sm w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold tracking-tight mb-2">Welcome to CHATR</h1>
          <p className="text-white/50 text-sm">Preparing your intelligent workspace...</p>
        </div>
