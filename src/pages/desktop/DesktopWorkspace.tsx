    ...
    <div className={cn("flex h-full font-sans overflow-hidden", isDark ? "bg-[#0a0a12] text-white" : "bg-white text-zinc-950")}>
      ...
      <div className="w-64 shrink-0 border-r border-white/[0.06] bg-[#0b0b14] flex flex-col relative z-20">
        ...
        <div className="h-16 px-4 flex items-center justify-between border-b border-white/[0.04]">
          <h2 className="text-sm font-bold text-white/90">Calendar</h2>
          ...
          <div className="p-4 space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-bold text-white/90">{format(currentDate, 'MMMM yyyy')}</span>
            ...
            <div>
              ...
              <div className="space-y-0.5">
                <div className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-white/5 cursor-pointer">
                  ...
                  <span className="text-xs text-white/90 font-medium">{currentUserName || 'Personal Calendar'}</span>
                </div>
              </div>
            </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 relative bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-fixed">
        ...
        <div className="h-16 shrink-0 border-b border-white/[0.06] bg-zinc-950/80 backdrop-blur-md flex items-center justify-between px-6 relative z-10">
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              className="h-8 px-3 rounded-lg bg-zinc-900 border-white/10 text-xs font-semibold hover:bg-zinc-800 text-white"
            ...
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-white/90 min-w-[120px] text-center">
          ...
          <div className="flex items-center gap-2">
            <div className="flex bg-zinc-900 rounded-lg p-0.5 border border-white/10">
              <button className="px-3 py-1 rounded-md text-xs font-medium text-white/50 hover:text-white transition-colors">Day</button>
              <button className="px-3 py-1 rounded-md bg-white/10 text-xs font-bold text-white shadow-sm">Week</button>
              <button className="px-3 py-1 rounded-md text-xs font-medium text-white/50 hover:text-white transition-colors">Month</button>
            </div>
            ...
            {weekDays.map((day, i) => {
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center justify-center py-3 border-r border-white/[0.06] last:border-r-0">
                  ...
                  <div className={cn(
                    "w-8 h-8 rounded-full flex items-center justify-center text-lg font-light",
      ...
      <div className="w-80 shrink-0 border-l border-white/[0.06] bg-[#0b0b14] flex flex-col relative z-20">
        ...
        {selectedTaskId ? (() => {
            ...
            <>
              ...
              <div className="h-16 shrink-0 flex items-center justify-between px-4 border-b border-white/[0.04]">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-bold text-white/90 truncate max-w-[200px]">{activeTask?.title || 'Task Details'}</h3>
                </div>
                ...
                <div className="p-4 flex flex-col gap-6">
                  ...
                  <div className="p-4 rounded-xl bg-zinc-900 border border-white/10 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={cn("text-xs font-bold", activeTask?.done ? "text-emerald-400" : "text-amber-400")}>
                        {activeTask?.done ? "Completed" : "In Progress"}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] text-white/40 uppercase tracking-wider">Priority</span>
                      <span className="text-xs font-medium text-white/80 capitalize">{activeTask?.priority || 'Medium'}</span>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="text-xs font-bold text-white/90">Discussion</h4>
                    </div>
          ...
          <>
            ...
            <div className="h-16 shrink-0 flex items-center justify-between px-4 border-b border-white/[0.04]">
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-bold text-white/90">Tasks & Agent</h3>
              </div>
              <div className="flex gap-1">
          ...
          <div className="p-4 flex flex-col gap-6">
            ...
            <div className="rounded-2xl bg-gradient-to-b from-violet-500/10 to-transparent border border-violet-500/20 p-4 relative overflow-hidden">
              ...
              <div className="flex items-center gap-2 mb-3 relative z-10">
                ...
                <h4 className="text-xs font-bold text-violet-300">Scheduling Agent</h4>
              </div>
              ...
              <div className="relative z-10">
                ...
                <Input 
                  ...
                  className="bg-zinc-900 border-white/10 text-xs pl-9 rounded-xl focus:border-violet-500/50"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <ListTodo className="w-4 h-4 text-emerald-400" />
                  <h4 className="text-xs font-bold text-white/90">Action Items</h4>
              ...
              <div className="mb-3">
                <Input
                  ...
                  className="bg-zinc-900 border-white/10 text-xs rounded-xl focus:border-emerald-500/50 placeholder:text-white/20"
                />
              </div>
