          ...
          <div className="flex items-center gap-2">
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border border-white/10 text-white/60 hover:text-white/90 hover:bg-white/[0.06] transition-colors"
              >
                <CheckCheck className="w-3.5 h-3.5" />
                Mark all read
              </button>
