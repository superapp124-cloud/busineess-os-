  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <span className="text-xs font-semibold text-white/90">Running Workflows</span>
      ...
      <div className="space-y-2">
        {isLoading && workflows.length === 0 ? (
          ...
          <p className="text-xs text-white/40 italic">No active workflows</p>
        ) : (
          workflows.map((wf: any) => (
            <div key={wf.id} className="flex items-center justify-between group">
              <div className="flex items-center gap-2 overflow-hidden">
                ...
                <span className="text-xs text-white/70 truncate">{wf.name}</span>
              </div>
