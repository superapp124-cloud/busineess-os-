      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col gap-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">Documents & Media</h1>
              <p className="text-sm text-slate-400 mt-1">Manage, share, and organize all your files centrally.</p>
            </div>
          </div>
          <button className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-black/40 rounded-2xl p-5 border border-white/5 flex flex-col gap-3">
            ...
            <p className="text-xs text-slate-500">1.5 GB used of 10 GB</p>
          </div>
          <div className="bg-black/40 rounded-2xl p-5 border border-white/5 flex flex-col gap-3">
            <div className="flex items-center gap-3">
            ...
            <p className="text-xs text-slate-500">45 GB used of 100 GB</p>
          </div>
          <div className="bg-black/40 rounded-2xl p-5 border border-white/5 flex flex-col gap-3">
            <div className="flex items-center gap-3">
            ...
            <p className="text-2xl font-bold text-white mt-auto">128</p>
          </div>
          <div className="bg-black/40 rounded-2xl p-5 border border-white/5 flex flex-col gap-3">
            <div className="flex items-center gap-3">
            ...
            <p className="text-2xl font-bold text-white mt-auto">45</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-[#111116] rounded-3xl border border-white/5 p-12 flex flex-col items-center justify-center text-center mt-4">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Your file repository is empty</h2>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <button className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all">
              Upload Files
            </button>
          </div>
        </div>
