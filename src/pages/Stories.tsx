      ...
      <div className="mx-auto max-w-[620px] space-y-6 px-4 pb-8">
        <section className="space-y-3 px-1">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">Stories</p>
              <p className="mt-1 text-sm text-foreground">Tap a ring to watch</p>
            </div>
            {contactGroups.length > 0 ? (
              <p className="text-xs text-muted-foreground">{contactGroups.length} active now</p>
            ) : null}
          </div>
          ...
          <div className="flex gap-3 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            ...
            {contactGroups.map((group) => (
              ...
              >
                ...
                <div>
                  <p className="max-w-[82px] truncate text-xs font-semibold text-foreground">
                    {group.displayName}
                  </p>
        ...
        <section className="rounded-[24px] border border-black/[0.04] bg-white/94 p-4 shadow-[0_14px_30px_rgba(15,23,42,0.06)]">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-foreground">Share a quick note</p>
          ...
          <div className="mt-4 rounded-[22px] border border-black/[0.05] bg-[#f8f9fd] p-4">
            <Textarea
              ...
              rows={2}
              className="resize-none border-0 bg-transparent px-0 text-base text-foreground shadow-none placeholder:text-muted-foreground/80 focus-visible:ring-0"
            />
        ...
        <section>
          ...
          {loading ? (
            ...
            <div className="rounded-[28px] border border-black/[0.04] bg-white px-5 py-10 text-center shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
              ...
              <p className="text-base font-semibold text-foreground">No updates yet</p>
              <p className="mt-1 text-sm text-muted-foreground">
