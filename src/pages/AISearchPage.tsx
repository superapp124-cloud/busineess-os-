        ...
        <>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2 text-indigo-400">
              ...
              <span className="font-bold text-xl tracking-tight text-white">CHATR <span className="text-indigo-400 font-normal">AI Search</span></span>
            </div>
        ...
        {isIdle ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 order-2 lg:order-1">
              ...
              {cached && (
                <div className="mt-4 flex items-center justify-end text-xs text-gray-500 font-mono">
