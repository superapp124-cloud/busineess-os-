      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-muted-foreground">
            ...
            <p className="text-sm mt-1">Create your first broadcast message to reach your customers</p>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={5}
              />
              <p className="text-xs text-muted-foreground">{newBroadcast.message.length} characters</p>
            </div>
          </div>
          <DialogFooter>
