      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Discover and install plugins, connectors, and workflow templates.</p>
          </div>
                ...
                {filteredListings.map(listing => (
                  <Card key={listing.id} className="bg-slate-900/60 border-slate-800 flex flex-col">
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription className="text-xs line-clamp-1">by {listing.author}</CardDescription>
                    </CardHeader>
                    <CardContent className="flex-grow">
                      <p className="text-sm text-slate-400 line-clamp-3">{listing.description}</p>
                    </CardContent>
