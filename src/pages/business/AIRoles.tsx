    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-muted-foreground">
          ...
          <p className="text-lg font-medium">No AI Roles configured</p>
          <p className="text-sm mt-1">Create your first AI team member to start automating customer interactions</p>
