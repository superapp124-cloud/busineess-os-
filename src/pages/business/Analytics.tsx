          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {prevSnapshot.total_revenue > 0 && (() => {
                  ...
                  return (
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <span className={`text-xs font-medium ${g >= 0 ? 'text-green-500' : 'text-red-500'}`}>{g > 0 ? '+' : ''}{g}%</span>
            ...
            <Card className="glass-card hover:shadow-glow transition-all animate-fade-in group relative overflow-hidden" style={{ animationDelay: '0.1s' }}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">{snapshot.converted_leads} converted</p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card hover:shadow-glow transition-all animate-fade-in group relative overflow-hidden" style={{ animationDelay: '0.2s' }}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">{snapshot.total_conversations} conversations</p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card hover:shadow-glow transition-all animate-fade-in group relative overflow-hidden" style={{ animationDelay: '0.3s' }}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">{snapshot.open_conversations} open conversations</p>
              </CardContent>
            </Card>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="glass-card animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-1">in the last {timeRange}</p>
              </CardContent>
            </Card>
