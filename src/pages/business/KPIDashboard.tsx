  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Business KPIs</h1>
          <p className="text-sm text-slate-400 mt-1">Platform performance and adoption metrics over the last 30 days.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white mt-2">{metrics.success_rate}%</p>
                </div>
          ...
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-400">Total Executions</p>
                  <p className="text-3xl font-bold text-white mt-2">{metrics.total_runs.toLocaleString()}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white mt-2">{metrics.avg_duration}ms</p>
                </div>
          ...
          <Card className="bg-slate-900/60 border-slate-800">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-400">AI Workflow Adoption</p>
                  <p className="text-3xl font-bold text-white mt-2">{metrics.ai_usage_pct}%</p>
                </div>
        ...
        <Card className="bg-slate-900/60 border-slate-800">
          <CardHeader>
            <CardTitle className="text-base text-slate-300">Execution Volume (30 Days)</CardTitle>
          </CardHeader>
          <CardContent>
