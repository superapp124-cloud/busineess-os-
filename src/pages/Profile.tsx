          ...
          <TabsContent value="settings" className="space-y-3">
            ...
            <div className="native-card divide-y divide-border">
              ...
              >
                ...
                <div className="flex-1 text-left min-w-0">
                  <h3 className="font-medium text-sm">Chat Folders</h3>
              ...
              >
                ...
                <div className="flex-1 text-left min-w-0">
                  <h3 className="font-medium text-sm">Profile Themes</h3>
              ...
              >
                ...
                <div className="flex-1 text-left min-w-0">
                  <h3 className="font-medium text-sm">AI Wallpapers</h3>
              ...
              >
                ...
                <div className="flex-1 text-left min-w-0">
                  <h3 className="font-medium text-sm">App Icon</h3>
