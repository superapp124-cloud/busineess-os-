...
const actionButtonStyle =
  'inline-flex items-center justify-center rounded-full border border-white/12 bg-white/10 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-white/16 active:scale-[0.99]';
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3 rounded-full border border-white/10 bg-white/10 px-4 py-3 backdrop-blur-xl">
          ...
          <span className="text-sm font-medium">Opening story composer...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="relative flex min-h-[100dvh] flex-col">
        ...
        >
          ...
          <div className="text-center">
            ...
            <h1 className="mt-1 text-lg font-bold text-white flex items-center gap-1.5 justify-center">
          ...
          <button
            ...
            className="inline-flex min-w-[94px] items-center justify-center rounded-full bg-white/18 px-4 py-3 text-sm font-semibold text-white backdrop-blur-xl transition-colors hover:bg-white/24 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {uploading ? (
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-4 rounded-[28px] border border-white/10 bg-white/8 p-4 backdrop-blur-xl">
                <textarea
                  ...
                  rows={3}
                  className="w-full resize-none border-0 bg-transparent text-base text-white outline-none placeholder:text-white/45"
                />
                <div className="mt-2 text-right text-xs text-white/50">{caption.length}/180</div>
              </div>
            </div>
          ) : (
            <div className="flex flex-col">
              ...
              >
                <div className="inline-flex items-center gap-2 self-start rounded-full border border-white/12 bg-white/10 px-3 py-1.5 text-sm text-white/75">
                ...
                <div className="mt-5 flex items-center justify-between gap-3 border-t border-white/10 pt-4">
                  ...
                  <div className="text-sm text-white/65">{textStory.length}/500</div>
                </div>
              </div>
            </div>
          )}
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    className={cn(
                      'p-3 rounded-xl border text-xs font-semibold transition-all text-center col-span-2',
                      selectedTemplate === 'book-appt'
            ...
            {selectedCta !== 'none' && selectedCta !== 'Message Me' && selectedCta !== 'View Business' && (
              <div className="space-y-1.5 animate-fadeIn">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/12 rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-white/30 outline-none focus:border-primary/50"
                />
              </div>
            )}
          </div>
